<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (TABACALERA) Cron Job
...
// TABACALERA: CAPISoft etapa_id terminal -> GHL opportunity status
// (según tus equivalencias operativas)
$CAPI_TO_GHL_TERMINAL_STATUS = [
    316 => 'won',       // Vendido -> Won
    317 => 'lost',      // Cancelado -> Lost
    318 => 'abandoned', // Cerrado Perdido -> Abandoned
];
...
$logFile   = $logsDir . "/capisoft_terminal_status_tabacalera.log";
