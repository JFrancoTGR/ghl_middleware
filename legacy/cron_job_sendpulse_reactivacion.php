...
// Tiempos en segundos
const TIEMPO_TOQUE_2 = 90;  // 60 minutos
const TIEMPO_TOQUE_3 = 240; // 7 horas
const TIEMPO_CIERRE  = 300; // 8 horas (1hr después del toque 3, si no responde → no interesado)
