<?php
// ============================================
// CAPISoft -> GHL Stage Sync (JUAREZ) Cron Job
// - proyecto_id = 1 (JUAREZ)
...
// JUAREZ location + pipeline
$GHL_LOCATION_ID = "2cOAVW7auz2agTWyCnxF";
$GHL_PIPELINE_ID = "RoLbh8p7EVEykLlVL2IB"; // JUAREZ - Flujo de venta

// Custom field ID in GHL for capisoft_stage
$GHL_CF_CAPISOFT_STAGE_ID = "9akn1HKwx4LzwwKING1w";

// CAPISoft etapa_id -> GHL pipelineStageId (JUAREZ)
$CAPI_TO_GHL_STAGE = [
    1   => 'e10f960c-8416-4166-9fae-993003511141', // Prospecto
    241 => '119f0215-59c7-4d37-9018-c36123a48765', // Buscando contacto
    2   => '9497216f-5867-43f8-aafe-0c8e7b0596f5', // Seguimiento
    242 => '1f6d2e65-a41c-40c5-b2d2-8dd58fdabb3f', // Citado -> Cita
    243 => '91b69ed5-46bc-4f1b-ac27-6a4abd17e0d6', // Visita
];
...
if ($proyectoId !== 1) {
    echo json_encode(['ok' => false, 'error' => 'Este script está fijo para JUAREZ (proyecto_id=1).']);
    exit(1);
}
...
$logFile   = $logsDir . "/capisoft_sync_juarez.log";
