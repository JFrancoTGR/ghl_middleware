<?php
// ============================================
// CAPISoft -> GHL Stage Sync (LIVERPOOL) Cron Job
// - proyecto_id = 2 (LIVERPOOL)
...
// LIVERPOOL location + pipeline
$GHL_LOCATION_ID = "2cOAVW7auz2agTWyCnxF";
$GHL_PIPELINE_ID = "MTUZz0ZEQial6a52574i"; // LIVERPOOL - Flujo de venta

// Custom field ID in GHL for capisoft_stage
$GHL_CF_CAPISOFT_STAGE_ID = "9akn1HKwx4LzwwKING1w";

// CAPISoft etapa_id -> GHL pipelineStageId (LIVERPOOL)
$CAPI_TO_GHL_STAGE = [
    16  => 'cfd2046d-b7d9-4976-acf0-35ed61538158', // Prospecto
    244 => '372406d4-01c5-42fa-8920-eee5db52d1c7', // Buscando contacto
    17  => 'ce1c293d-aee0-4a7a-b141-25a02a40c16a', // Seguimiento
    246 => '763d9879-29b1-457e-ae0e-c2585c20e81a', // Citado -> Cita
    247 => '31151c1e-3a51-4617-b42e-17a1606b3c39', // Visita
];
...
if ($proyectoId !== 2) {
    echo json_encode(['ok' => false, 'error' => 'Este script está fijo para LIVERPOOL (proyecto_id=2).']);
    exit(1);
}
...
$logFile   = $logsDir . "/capisoft_sync_liverpool.log";
