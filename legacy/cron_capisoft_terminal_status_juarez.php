<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (JUAREZ) Cron Job
...
// JUAREZ: CAPISoft etapa_id terminal -> GHL opportunity status
// (según tus equivalencias operativas)
$CAPI_TO_GHL_TERMINAL_STATUS = [
    4 => 'won',       // Vendido -> Won
    5 => 'lost',      // Cancelado -> Lost
    6 => 'abandoned', // Cerrado Perdido -> Abandoned
];
...
$logFile   = $logsDir . "/capisoft_terminal_status_juarez.log";
