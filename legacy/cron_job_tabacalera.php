<?php
// ============================================
// CAPISoft -> GHL Stage Sync (TABACALERA) Cron Job
// - proyecto_id = 19 (TABACALERA)
...
// CAPISoft etapa_id -> GHL pipelineStageId (TABACALERA)
$CAPI_TO_GHL_STAGE = [
    313 => '463dcf13-98af-4fe7-a97f-680601951a2f6', // Prospecto
    328 => '0d13b615-5d1b-47a2-b6a1-4e49df3db514',  // Buscando contacto
    329 => '9dc960e3-403b-48f7-ba1d-73d5d3a650ab',  // Seguimiento
    330 => 'dec11ccd-446b-4826-a0ad-64a2bd07eaef',  // Citado -> Cita
                                                    //259 => '91b69ed5-46bc-4f1b-ac27-6a4abd17e0d6', // Visita
];
...
if ($proyectoId !== 19) {
    echo json_encode(['ok' => false, 'error' => 'Este script está fijo para TABACALERA (proyecto_id=19).']);
    exit(1);
}
...
$logFile   = $logsDir . "/capisoft_sync_tabacalera.log";
