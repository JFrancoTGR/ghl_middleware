<?php
/**
 * Meta CAPI Backfill (last 7 days) - NAOS (multi-milestone, WON by status)
 *
 * Rules:
 * 1) Only Meta leads:
 ...
 *
 * Run:
 *   php meta_backfill_naos_7days_milestones.php
 */

if (php_sapi_name() !== 'cli') { http_response_code(403); exit("CLI only\n"); }

// -------------------- CONFIG (WAVVE) --------------------
$GHL_TOKEN  = getenv('GHL_TOKEN_NAOS') ?: 'GHL_TOKEN';
$META_TOKEN = getenv('META_TOKEN_NAOS') ?: 'META_TOKEN';

$LOCATION_ID = 'PKIWfuiKgY90ZpNOwqCO';
$DATASET_ID  = '1532609404445820';

$PIPELINE_ID = '1r3wDH5gGkMl8Y7fnPBF';

// ✅ Pon tus stage IDs reales
$STAGE_ID_SEGUIMIENTO = 'bc58ad63-3c56-4d6b-977a-ae34ae41d772';
$STAGE_ID_CITA        = 'c4f6be4b-4d53-46f3-830b-bf3fe40ed590';
$STAGE_ID_VISITA      = '5bdaff91-6540-4941-a344-7f9f277795cb';
...
$REGISTRY_PATH = "{$REGISTRY_DIR}/meta_backfill_registry_naos_milestones.json";
