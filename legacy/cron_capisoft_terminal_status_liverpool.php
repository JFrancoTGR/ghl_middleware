<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (LIVERPOOL) Cron Job
...
// LIVERPOOL: CAPISoft etapa_id terminal -> GHL opportunity status
// (según tus equivalencias operativas)
$CAPI_TO_GHL_TERMINAL_STATUS = [
    19 => 'won',       // Vendido -> Won
    20 => 'lost',      // Cancelado -> Lost
    21 => 'abandoned', // Cerrado Perdido -> Abandoned
];
...
$logFile   = $logsDir . "/capisoft_terminal_status_liverpool.log";
