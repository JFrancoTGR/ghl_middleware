<?php
// ============================================
// CAPISoft -> GHL Stage Sync (CHILPANCINGO) Cron Job
...
$CAPI_TO_GHL_STAGE = [
    61  => 'd3a01800-5099-4166-b616-1727f0bc1126', // Prospecto
    234 => '4f7cef3d-2aa4-4c70-83b0-3e981dce4b1f', // Buscando contacto
    62  => 'b3bd8bd1-9b80-4b47-b402-161dc2e1d4e4', // Seguimiento
    235 => '6b538a94-3960-4219-965d-7e58bd2bc3bc', // Citado -> Cita
    236 => 'a3d1f534-ce3b-478a-90d8-f019f46ef6ce', // Visita
];
...
$logFile   = $logsDir . "/capisoft_sync_chilpancingo.log";
