<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (CHILPANCINGO) Cron Job
...
// CHILPANCINGO: CAPISoft etapa_id terminal -> GHL opportunity status
// (según tus equivalencias operativas)
$CAPI_TO_GHL_TERMINAL_STATUS = [
    64 => 'won',       // Vendido -> Won
    65 => 'lost',      // Cancelado -> Lost
    66 => 'abandoned', // Cerrado Perdido -> Abandoned
];
...
$logFile   = $logsDir . "/capisoft_terminal_status_chilpancingo.log";
