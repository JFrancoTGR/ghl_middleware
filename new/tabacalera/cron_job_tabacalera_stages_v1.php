<?php
// ============================================
// CAPISoft -> GHL Stage Sync (TABACALERA) [PRODUCTIVO V1]
// - Open stages only
...
$RUNTIME_PROJECT_ID       = 19;
$RUNTIME_SINCE_DATE       = '2026-01-01';
...
$GHL_PIPELINE_ID = '6s1owHRay62fiFyuuugl';
$GHL_CF_CAPISOFT_STAGE_ID = '9akn1HKwx4LzwwKING1w';

$CAPI_TO_GHL_STAGE = [
    313 => 'dec11ccd-446b-4826-a0ad-64a2bd07eaef', // Asignado
    328 => '5f9dfed5-16c6-439c-9d71-06a2c5ce68d8', // Buscando contacto CAPI
    330 => 'a5e3c461-2e6c-4272-9ddb-4652953af82f', // Enfriado
    329 => '023109bb-3de0-4cfa-85ae-95869c1759b3', // Nurture
    331 => 'f06f2f20-000a-4549-816c-44deee0ff117', // Seguimiento
    314 => '31547cf2-3c92-4323-84a5-1a79502b810c', // Negociación
...
$stateFile    = $storageDir . '/capisoft_state_project_19_stage_productive.json';
$progressFile = $storageDir . '/capisoft_progress_project_19_stage_productive.json';
$lockFile     = $storageDir . '/capisoft_shared_project_19.lock';
$logFile      = $logsDir . '/capisoft_stage_tabacalera_productive.log';
...
while ($idx < $totalFiltered) {
    ...
    $currentContactOwner = (string)($contact['assignedTo'] ?? '');
    $currentOppOwner = (string)($opp['assignedTo'] ?? $opp['assignedUserId'] ?? '');
    ...
    $needsOppOwner = ($targetOwnerId && $currentOppOwner !== $targetOwnerId);
