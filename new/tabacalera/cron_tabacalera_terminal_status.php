<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (TABACALERA) Cron Job [V2 - batched]
...
// - TERMINAL ONLY: 316 => won, 317 => lost, 318 => abandoned
...
$logMode            = normalize_log_mode(get_arg('log_mode'), $defaultLogMode);
...
$logFile      = $logsDir . '/capisoft_terminal_status_tabacalera_productive.log';
