<?php
// ============================================
// CAPISoft -> GHL Stage Sync (VASCONCELOS) [PRODUCTIVO V1]
// - Open stages only
...
$GHL_PIPELINE_ID = 'gspiDeL4dIerU82mCS7O';
$GHL_CF_CAPISOFT_STAGE_ID = '9akn1HKwx4LzwwKING1w';

$CAPI_TO_GHL_STAGE = [
    168  => '4f253274-3528-4b6e-aa23-2f5075416bd4', // Asignado
    252 => 'a9a85535-2123-4ceb-bf18-2213a425dd65', // Buscando contacto CAPI
    360 => 'b7567041-b4d7-4323-87a8-785e0d013ab8', // Enfriado
    361 => '833b93a3-54fa-47bc-98e5-208fe9eae34e', // Nurture
    253  => '3fe58a0f-c10a-4dea-8e0c-b58b1dc30b1c', // Seguimiento
    169 => 'c03b7f35-ac5f-48ce-82ca-b49bf997e672', // Negociación
...
$stateFile    = $storageDir . '/capisoft_state_project_12_stage_productive.json';
$progressFile = $storageDir . '/capisoft_progress_project_12_stage_productive.json';
$lockFile     = $storageDir . '/capisoft_shared_project_12.lock';
$logFile      = $logsDir . '/capisoft_stage_vasconcelos_productive.log';
$lockSkipFile = $logsDir . '/stage_lock_skips.log';
$ownerFixTraceFile = $logsDir . '/capisoft_stage_vasconcelos_ownerfix_trace.log';
