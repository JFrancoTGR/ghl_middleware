<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (VASCONCELOS) Cron Job [V2 - batched]
// - proyecto_id = 12 (VASCONCELOS)
...
// - TERMINAL ONLY: 171 => won, 172 => lost, 173 => abandoned
...
$defaultProyectoId         = 12;
$defaultSinceDate          = '2026-06-01';
$defaultDryRun             = false;
$defaultBatchSize          = 30;
...
$GHL_PIPELINE_ID = "gspiDeL4dIerU82mCS7O"; // VASCONCELOS - Flujo de venta
...
if ($proyectoId !== 12) {
    echo json_encode(['ok' => false, 'error' => 'Este script está fijo para VASCONCELOS (proyecto_id=12).']);
    exit(1);
}
...
$logFile      = $logsDir . '/capisoft_terminal_status_hamburgo_productive.log';
