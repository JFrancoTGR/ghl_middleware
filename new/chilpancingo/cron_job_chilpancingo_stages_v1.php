<?php
// ============================================
// CAPISoft -> GHL Stage Sync (CHILPANCINGO) [PRODUCTIVO V1]
// - Open stages only
...
$GHL_PIPELINE_ID = 'mBsz4BC5Yw9yVf9cfdZj';
...
$stateFile    = $storageDir . '/capisoft_state_project_5_stage_productive.json';
$progressFile = $storageDir . '/capisoft_progress_project_5_stage_productive.json';
$lockFile     = $storageDir . '/capisoft_shared_project_5.lock';
$logFile      = $logsDir . '/capisoft_stage_chilpancingo_productive.log';
