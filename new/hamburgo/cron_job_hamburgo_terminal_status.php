<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (HAMBURGO) Cron Job [V2 - batched]
// - proyecto_id = 13 (HAMBURGO)
...
// - TERMINAL ONLY: 186 => won, 187 => lost, 188 => abandoned
...
$GHL_PIPELINE_ID = "oUHz8QHC9rIw0J7QnNwa"; // HAMBURGO - Flujo de venta
...
if ($proyectoId !== 13) {
    echo json_encode(['ok' => false, 'error' => 'Este script está fijo para HAMBURGO (proyecto_id=13).']);
    exit(1);
}
