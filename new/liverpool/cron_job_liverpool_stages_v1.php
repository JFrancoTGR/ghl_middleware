<?php
// ============================================
// CAPISoft -> GHL Stage Sync (LIVERPOOL) [PRODUCTIVO V2]
// - Open stages only
...
$GHL_PIPELINE_ID = 'MTUZz0ZEQial6a52574i';
$GHL_CF_CAPISOFT_STAGE_ID = '9akn1HKwx4LzwwKING1w';

$CAPI_TO_GHL_STAGE = [
    16  => '763d9879-29b1-457e-ae0e-c2585c20e81a', // Asignado
    244 => '3713faf6-1792-4ee7-b290-6c0b3fcf6672', // Buscando contacto CAPI
    246 => 'da93e96d-0f28-4a62-ab39-50db867b2992', // Enfriado
    354 => '1ceb73b4-aeaf-4bb6-a06f-d1fbd131cc78', // Nurture
    17  => '82a14638-763f-4599-b393-5db59d3f6569', // Seguimiento
    247 => '0bf260a7-cf47-4230-a749-549776c66cea', // Negociación
...
$stateFile    = $storageDir . '/capisoft_state_project_2_stage_productive.json';
$progressFile = $storageDir . '/capisoft_progress_project_2_stage_productive.json';
$lockFile     = $storageDir . '/capisoft_shared_project_2.lock';
$logFile      = $logsDir . '/capisoft_stage_liverpool_productive.log';
