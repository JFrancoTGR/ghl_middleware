<?php
// ============================================
// CAPISoft -> GHL Stage Sync (LIVERPOOL) [PRODUCTIVO OWNERFIX]
// - Open stages only
...
// - OWNERFIX: dedicated trace log for owner-decision diagnostics
...
$ownerFixTraceFile = $logsDir . '/capisoft_stage_liverpool_ownerfix_trace.log';
