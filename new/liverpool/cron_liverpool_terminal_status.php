<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (LIVERPOOL) Cron Job [V2 - batched]
// - proyecto_id = 2 (LIVERPOOL)
// - since_date filter by CAPISoft created_at
// - DRY RUN default = 0 (productive writes enabled)
...
// - TERMINAL ONLY: 19 => won, 20 => lost, 21 => abandoned
...
$logFile      = $logsDir . '/capisoft_terminal_status_liverpool_productive.log';
